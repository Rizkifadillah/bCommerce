...
class OrderController extends Controller
{
	...
	public function __construct()
    {
        ...
        $this->middleware('permission:add_orders', ['only' => ['cancel', 'doCancel']]);
        $this->middleware('permission:edit_orders', ['only' => ['edit', 'doComplete']]);
        $this->middleware('permission:delete_orders', ['only' => ['destroy', 'restore']]);

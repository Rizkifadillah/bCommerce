...
class OrderController extends Controller
{
	...
	public function index()
	{
		...
		return view('themes.ezone.orders.index', $this->data);
	}
	...
	public function show($id)
	{
		...
		return view('themes.ezone.orders.show', $this->data);
	}
    ...
    public function checkout(){
        ...
        // \dd($this->data['provinces']);

        return view('themes.ezone.orders.checkout', $this->data);
    }
	...
	{
		// $message = new OrderReceived($order);
	...
	public function received($orderId)
	{
		...
		return view('themes.ezone.orders.received', $this->data);
	}
}

        ...
        <div id="full-slider-wrapper">
            <div id="layerslider" style="width:100%;height:450px; ">
                ...
                <div class="ls-slide" data-ls="transition3d:all; timeshift:-1000; slidedelay: 7000;">
                    ...
                    <img  src="{{ asset('assets/frontend/img/resource/main-slide3.jpg')}}" class="ls-bg" alt="Slide background"/>
                ...
                <div class="ls-slide" data-ls="transition3d:all; timeshift:-1000; slidedelay: 7000;">
                    ...
                    <img  src="{{ asset('assets/frontend/img/resource/main-slide2.jpg')}}" class="ls-bg" alt="Slide background"/>
                ...
                <div class="ls-slide" data-ls="transition3d:all; timeshift:-1000; slidedelay: 6000;">
                    ...
                    <img  src="{{ asset('assets/frontend/img/resource/main-slide1.jpg')}}" class="ls-bg" alt="Slide background"/>

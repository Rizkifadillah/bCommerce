		...
		<div class="footer-wrapper style-3">
			<div class="type-1">
				<div class="footer-columns-entry">
					<div class="row">
						<div class="col-md-3">
							<img alt="" src="{{ asset('assets/frontend/img/footer-logo.png')}}" class="footer-logo">
					...
					<div class="footer-bottom-navigation">
						...
						<div class="cell-view">
							<div class="payment-methods">
								<a href="#"><img alt="" src="{{ asset('assets/frontend/img/payment-method-1.png')}}"></a>
								<a href="#"><img alt="" src="{{ asset('assets/frontend/img/payment-method-2.png')}}"></a>
								<a href="#"><img alt="" src="{{ asset('assets/frontend/img/payment-method-3.png')}}"></a>
								<a href="#"><img alt="" src="{{ asset('assets/frontend/img/payment-method-4.png')}}"></a>
								<a href="#"><img alt="" src="{{ asset('assets/frontend/img/payment-method-5.png')}}"></a>
								<a href="#"><img alt="" src="{{ asset('assets/frontend/img/payment-method-6.png')}}"></a>
							</div>
						</div>
					</div>
				</div>

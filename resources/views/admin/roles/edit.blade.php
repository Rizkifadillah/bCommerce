...
@section('breadcumbs')
  {{ Breadcrumbs::render('edit_roles_title', $role) }}
                                    ...
                                    <div class="form-check form-check-flat">
                                        <label for="{{ $permission}}" class="form-check-label">
                                            @if (old('permissions',$permissionChecked))
                                                <input id="{{ $permission }}" name="permissions[]" type="checkbox" value="{{ $permission }}" {{ in_array($permission,old('permissions',$permissionChecked)) ? "checked" : null }} class="form-check-input " name="category[]"> 
                                            @else
